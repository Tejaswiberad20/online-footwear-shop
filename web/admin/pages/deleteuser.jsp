...
<%
    ...
    out.println("console.log('Received ID: " + ID + "');"); // Log the ID value to the browser console
    out.println("</script>");
    ...
    try {
        ...
        String checkSql = "SELECT COUNT(*) FROM reg WHERE ID = ?";
        pst = con.prepareStatement(checkSql);
        pst.setInt(1, Integer.parseInt(ID)); // Set the ID parameter for the query
        ...
        if (rs.next() && rs.getInt(1) > 0) {
            ...
            pst.setInt(1, Integer.parseInt(ID)); // Set the ID parameter for deletion
